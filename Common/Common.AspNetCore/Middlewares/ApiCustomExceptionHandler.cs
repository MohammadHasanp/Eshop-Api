...
namespace Common.AspNetCore.Middlewares
{
    ...
    public class ApiCustomExceptionHandler
    {
        ...
        private readonly ILogger<ApiCustomExceptionHandler> _logger;

        public ApiCustomExceptionHandler(RequestDelegate next,
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            AppStatusCode apiStatusCode = AppStatusCode.Success;
